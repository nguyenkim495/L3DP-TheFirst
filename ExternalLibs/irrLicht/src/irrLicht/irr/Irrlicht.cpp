...
namespace irr
{
	...
	//IRRLICHT_API IrrlichtDevice* IRRCALLCONV createDevice(video::E_DRIVER_TYPE driverType, //christmas.nguyen Compiler Error C2491
	IrrlichtDevice* IRRCALLCONV createDevice(video::E_DRIVER_TYPE driverType,
	...
	//extern "C" IRRLICHT_API IrrlichtDevice* IRRCALLCONV createDeviceEx(const SIrrlichtCreationParameters& params) //christmas.nguyen Compiler Error C2491
	extern "C" IrrlichtDevice* IRRCALLCONV createDeviceEx(const SIrrlichtCreationParameters& params)
	{
